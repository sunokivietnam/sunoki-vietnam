...
để tạo nên những công trình tinh tế,
bền vững và mang đậm dấu ấn
của mỗi khách hàng.`,
...
collectionTitleMobile: `Chất liệu chọn lọc. 
Chuẩn Nhật trong từng đường nét`,
...
collectionDescriptionMobile: `Chúng tôi tôn vinh vẻ đẹp thuần khiết của gỗ, 
  ...
  kiến tạo nên những không gian sống 
  được hoàn thiện tinh xảo.`,
...
chất lượng Nhật Bản.`,
    ...
    items: [
  {
    ...
    description:
  "Thiết kế, xây mới và cải tạo nhà ở theo tiêu chuẩn Nhật Bản,\ntối ưu công năng và kiến tạo không gian sống tiện nghi, thoải mái.",
...
hài hòa giữa công năng, tiện nghi và thẩm mỹ.`,
    ...
    commercial: {
      ...
      description:
  "Thiết kế và thi công nhà hàng, văn phòng cùng các không gian thương mại, đảm bảo sự cân bằng giữa tính thẩm mỹ, công năng và trải nghiệm của khách hàng.",
...
descriptionMobile:
  "Thiết kế và thi công nhà hàng, văn phòng cùng các không gian thương mại.\nĐảm bảo sự cân bằng giữa tính thẩm mỹ, công năng và trải nghiệm khách hàng.",
      ...
      items: [
        ...
        {
          title: "Kệ trưng bày rượu",
          subtitle: "SAKE DISPLAY",
        },
        {
          title: "Ghế Kamakura",
...
như ngoài đời thực.`,
  ...
  descriptionMobile:
  "Tỉ mỉ trong từng chi tiết,\nchuẩn mực trong từng công đoạn.\n\nChúng tôi ứng dụng tiêu chuẩn Nhật Bản vào thiết kế và thi công, mang đến những không gian bền vững, tiện nghi và đáng tin cậy.",
    ...
    items: [
      {
        ...
        area: "Quận 3, TP.HCM",
        comment:
          "Chất lượng thi công theo tiêu chuẩn Nhật Bản rất tỉ mỉ. Cả gia đình chúng tôi đều rất hài lòng với ngôi nhà sau khi hoàn thành.",
      },
      {
        name: "Tran Thi B",
        area: "TP. Thủ Đức",
        comment:
          "Từ lúc tư vấn đến khi hoàn thành, chúng tôi luôn cảm thấy yên tâm. Công trình hoàn thành đúng tiến độ như cam kết.",
      },
      {
        name: "Yamada",
        area: "Bình Thạnh",
