...
export default function Process() {
  ...
  <span className="md:hidden">
    {t.process.descriptionMobile}
        ...
        <div className="relative mt-16 hidden lg:block">
          ...
          <div className="absolute left-[8%] right-[8%] top-9 h-[2px] bg-[#B8895A]" />
  ...
  {step.title}
      ...
      <p className="mx-auto mt-3 min-h-[96px] max-w-[230px] whitespace-pre-line text-[14px] leading-6 text-[#666]">
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-center">
                ...
                {step.number !== "05" && (
  <div className="mt-2 h-20 w-px bg-[#D9C6B1]" />
)}
  ...
  <div className="mb-0 flex h-10 w-10 items-center justify-center rounded-full bg-[#F7F2EC]">
    <Icon
      size={20}
      strokeWidth={1.8}
      className="text-[#B8895A]"
  ...
  <p className="mt-1 whitespace-pre-line text-[13px] leading-[1.6] text-[#666]">
